...
const required = [
  ...
  "skills/contract-cli-employee/SKILL.md",
  "skills/contract-cli-employee/agents/openai.yaml",
  "skills/contract-cli-department/SKILL.md",
  "skills/contract-cli-department/agents/openai.yaml",
